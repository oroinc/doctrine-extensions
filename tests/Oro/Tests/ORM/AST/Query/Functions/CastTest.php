...
class CastTest extends TestCase
{
    ...
    public static function unsupportedTypeDataProvider(): array
    {
        return [
            'unknown type' => [
                'notatype',
    ...
    public static function splitTypeDataProvider(): array
    {
        return [
            ['char', ['char', []]],
            ['CHAR', ['char', []]],
    ...
    public static function malformedTypeDataProvider(): array
    {
        return [
